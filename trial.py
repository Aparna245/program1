...
encrypt_data1 = ''.join(L1)
print("data in numbers - ", encrypt_data1)

#data = int(encrypt_data1)
data_encrypted = encrypt(encrypt_data1)
print("Encrypted data is: ", data_encrypted)
...
cursor = con.cursor()
sql1 = "INSERT INTO files(File_Name,Content) VALUES (%s,%s)"
...
ret = input("Enter the data to be retrieved :")
sql2 = "SELECT * FROM files WHERE File_Name = %s"
cursor.execute(sql2, (ret,))
res = cursor.fetchall()
